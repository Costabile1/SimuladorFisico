...
link:
	g++ main.o Carga.o CargaLibre.o CargaEsferica.o Plano.o imgui.o imgui_draw.o imgui_widgets.o imgui_tables.o imgui-SFML.o -o sfml-simulador_fisico-app -L$(SFML_PATH)\lib -lsfml-graphics-s -lsfml-window-s -lsfml-system-s -lopengl32 -lfreetype -lwinmm -lgdi32 -lsfml-main
