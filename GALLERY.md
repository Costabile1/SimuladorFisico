...
- Primero ingresamos todos los datos en las unidades que el problema nos proporciona, al ser distancias tan pequeñas nos conviene cambiar el factor escala hasta un punto sean apreciables las distancias entre las cargas, por ejemplo factorEscala= 100000.0;
...
- Haciendo prueba y error encontramos un valor muy cercano a 0 en x=341.412 (recordemos que tenemos el sistema escalado por 10^5)
![imagenProblema1](docs/ejercicios/Problema1/Solucion.png)
- Comprobamos que la solucion es corrercta y que las diferencias son despreciables debudas a como la computadora redondea decimales
